...
```bash
cp scripts/participants.txt.example scripts/participants.txt
```
...
```bash
ssh-keygen -t ed25519 -C "upcloud-workshop" -f "$HOME/.ssh/upcloud_workshop_ed25519"
cat "$HOME/.ssh/upcloud_workshop_ed25519.pub"
```
